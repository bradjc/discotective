...
[measures stems] = find_lines_eighths_new(lineless_img, params, count.st, out);
...
%     symb_img = w_crop(cur_img, 1); % (1 => strict)
    ...
    if (out.cl)
        ...
        imagesc(1-symbols(symbol).img), colormap(gray) 
    ...
    if (out.sv)
        ...
        imwrite(1-symbols(symbol).img, path_name, 'tif');
