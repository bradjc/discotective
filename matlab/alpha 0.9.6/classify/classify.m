...
[measures notes] = find_lines(lineless_img, params, count.st, staff_lines, out);
...
com_symbols = classify_symbols(com_symbols,params,size(lineless_img,2),size(lineless_img,1),notes);
