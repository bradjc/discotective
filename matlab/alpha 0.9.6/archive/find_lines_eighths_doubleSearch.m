function [measures stems] = find_lines_eighths_new(img, parameters, staffNumber, out)
...
for i = 1:num_lines
    ...
    [mini_img topCut leftCut rightCut] = mini_img_cut_new(img,top,bottom,xbegin,xend,parameters);
